...
const CSS = `
.${RESIZER_CLASS} { flex-shrink: 0; box-sizing: border-box; touch-action: none; background: var(${RESIZER_COLOR_VAR}, ${DEFAULT_RESIZER_COLOR}); background-clip: content-box; -webkit-background-clip: content-box; opacity: 1; transition: opacity 200ms ease, background-color 150ms ease; }
...
@media (hover: none) { .${RESIZER_CLASS}.${RESIZER_CLASS_HOVER_ONLY} { opacity: 1; } }
`;
